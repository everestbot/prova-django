...
def index(request):
    """Exiber a página principal da aplicação."""
...
def edit(request):
    """Edita o conteúdo de um evento, recebendo os dados envoadps pelo
    formulário, validando e populando em um evento já existentes."""
...
def show(request, id: int):
    """Visulaização de um determinado evento e de seus comentários, recebe
